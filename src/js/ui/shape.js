...
import { defaultShapeStrokeValues, eventNames, selectorNames, REODER_DIRECTION } from '@/consts'
...
class Shape extends Submenu {
    constructor(subMenuElement, { locale, makeSvgIcon, menuBarPosition, usageStatistics }) {
        ...
        this._els = {
            ...
            reorderUpButton: this.selector('.tie-reorder-up'),
            reorderDownButton: this.selector('.tie-reorder-down'),
        }
        ...
        this.colorPickerInputBoxes.push(
            this._els.fillColorpicker.colorpickerElement.querySelector(selectorNames.COLOR_PICKER_INPUT_BOX),
        )
        this.colorPickerInputBoxes.push(
            this._els.strokeColorpicker.colorpickerElement.querySelector(selectorNames.COLOR_PICKER_INPUT_BOX),
        )
    }
    ...
    addEvent(actions) {
        ...
        this._els.reorderUpButton.addEventListener('click', this._reorderUp.bind(this))
        this._els.reorderDownButton.addEventListener('click', this._reorderDown.bind(this))
    ...
    _removeEvent() {
        ...
        this._els.reorderUpButton.removeEventListener('click', this._reorderUp.bind(this))
        this._els.reorderDownButton.removeEventListener('click', this._reorderDown.bind(this))
    ...
    _reorderUp() {
        this.actions.reorder(REODER_DIRECTION.UP)
    }

    _reorderDown() {
        this.actions.reorder(REODER_DIRECTION.DOWN)
    }
}
