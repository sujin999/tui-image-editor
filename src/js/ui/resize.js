...
class Resize extends Submenu {
    ...
    changeStartMode() {
        ...
        this.setLimit({
            ...
            maxWidth:
                Math.max(this.resolution.width, dimensions.width) ||
                dimensions.width,
            maxHeight:
                Math.max(this.resolution.height, dimensions.height) ||
                dimensions.height
        });
    }
    ...
    addEvent(actions) {
        this._els.widthRange.on(
            'change',
            this._changeWidthRangeHandler.bind(this)
        );
        this._els.heightRange.on(
            'change',
            this._changeHeightRangeHandler.bind(this)
        );
        this._els.lockAspectRatio.addEventListener(
            'change',
            this._changeLockAspectRatio.bind(this)
        );
