...
import { defaultIconPath, eventNames, selectorNames, REODER_DIRECTION } from '@/consts'
...
class Icon extends Submenu {
    constructor(subMenuElement, { locale, makeSvgIcon, menuBarPosition, usageStatistics }) {
        ...
        this._els = {
            ...
            reorderUpButton: this.selector('.tie-icon-reorder-up'),
            reorderDownButton: this.selector('.tie-icon-reorder-down'),
        }
    ...
    addEvent(actions) {
        ...
        console.log('icon this._els.reorderUpButton', this._els.reorderUpButton)
