...
import { defaultTextRangeValues, eventNames, selectorNames, REODER_DIRECTION } from '@/consts'
...
class Text extends Submenu {
    constructor(subMenuElement, { locale, makeSvgIcon, menuBarPosition, usageStatistics }) {
        ...
        this._els = {
            ...
            reorderUpButton: this.selector('.tie-text-reorder-up'),
            reorderDownButton: this.selector('.tie-text-reorder-down'),
        }
    ...
    setEffectState(effectName, value) {
        ...
        const button = this._els.textEffectButton.querySelector(`.tui-image-editor-button.${effectName}`)
